...
OUTPUT_DATA_PATH=/projects/helx/slack_data
BACKUP_PATH=/projects/helx/slack_data/backup
WEB_SLACK_PATH=/projects/helx/www/translator/teamscience/slackviz
...
SLACK_BOT_TOKEN=$2 python3.6 $1/slack_app.py $1 ${OUTPUT_DATA_PATH} inputData.json wordCloud.json rawMessage.txt
